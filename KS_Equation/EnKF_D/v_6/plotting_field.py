...
fig.tight_layout()
plt.show() 
fig.savefig('field_plot_ekfd6.pdf',bbox_inches='tight')
fig.savefig('field_plot_ekfd6.eps',bbox_inches='tight')
fig.savefig('field_plot_ekfd6.png',bbox_inches='tight',dpi=300)
