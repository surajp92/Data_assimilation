...
Af = np.zeros((ne+1,npe))   # square-root of the covariance matrix
...
#%%
np.savez('data_d_'+str(me)+'.npz',t=t,tobs=tobs,T=T,X=X,utrue=utrue,uobs=uobs,
