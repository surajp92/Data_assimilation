...
line_labels = ['True','Erroneous','EnKF-D','Observations']
...
fig.tight_layout()
plt.show() 
fig.savefig('time_series_enkfd2.pdf',bbox_inches='tight')
fig.savefig('time_series_enkfd2.eps',bbox_inches='tight')
fig.savefig('time_series_enkfd2.png',bbox_inches='tight',dpi=300)